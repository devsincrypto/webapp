		...
		<>
			<div className="thin-container">
				...
				<p>
					...
					blockchain ecosystem. Within each ecosystem, the developers
					are then ranked by their Github activity.
				</p>
				...
				<p>
					...
					subecosystems. Each ecosystem is uniquely identified by a
					&quot;/&quot;-delimited path. For example,{' '}
					<Link href="/ecosystem/regen-network">Regen Network</Link>,
					which is a subecosystem of the wider{' '}
					<Link href="/ecosystem/cosmos">Cosmos</Link> ecosystem, is
					identified by the path <code>cosmos/regen-network</code>.
				</p>
				...
				<p>
					...
					ecosystem&apos;s popularity is defined as the sum of all its
					associated Github repositories&apos; popularity.
				</p>
				<p>
				...
				<p>
					...
					contributing to popular repos will have a higher score. If
					you have ideas how to improve the estimation of a
					user&apos;s score, please{' '}
					<a
				...
				<p>All data shown on Crypto in Devs is publicly available.</p>
				<p>
